...
The `snp_df` data contains 787 observations related to Standard & Poor’s stock market index (S&P) represented by the variable "close" (the closing 
...
```{r}
rental_df <- read.csv("./zillow_data/Zip_zori_uc_sfrcondomfr_sm_month_NYC.csv") |>
  janitor::clean_names() |>
  # Pivot to long format
  pivot_longer(
    cols = x2015_01_31:x2018_05_31,
    names_to = "date",
